(() => {
  ...
  function ensureConnectivityControl() {
    ...
    if (!$('offlineV1RuntimeStyle')) {
      ...
      style.textContent = `
        .connectivity-mode{display:flex;align-items:center;gap:10px;justify-self:end;white-space:nowrap}.connectivity-copy{display:grid;gap:1px;text-align:right}.connectivity-copy strong{font-size:11px;color:var(--text)}.connectivity-copy small{font-size:9px;color:var(--muted)}.connectivity-switch{position:relative;width:52px;height:28px;border:1px solid var(--border-soft);border-radius:999px;background:#eee7dd;padding:3px;cursor:pointer;box-shadow:none;transition:background .18s ease,border-color .18s ease}.connectivity-switch::after{content:"";display:block;width:20px;height:20px;border-radius:50%;background:#fffaf4;border:1px solid rgba(68,58,48,.10);box-shadow:0 1px 3px rgba(61,48,36,.12);transition:transform .18s ease}.connectivity-switch.is-online{background:#252d36;border-color:#252d36}.connectivity-switch.is-online::after{transform:translateX(24px);background:#fffaf4;border-color:rgba(255,255,255,.12)}.connectivity-switch:hover{border-color:#c9986e}.connectivity-switch.is-online:hover{border-color:#252d36}.connectivity-switch:focus-visible{outline:2px solid #c9986e;outline-offset:2px}.live-rate-choices{margin-top:12px;padding:12px;border:1px solid rgba(84,224,180,.12);border-radius:14px;background:rgba(84,224,180,.035)}.live-rate-head{display:flex;justify-content:space-between;gap:12px;align-items:end;margin-bottom:8px}.live-rate-head strong{font-size:12px}.live-rate-head small{color:var(--muted-2);font-size:10px}.live-rate-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.live-rate-card{padding:10px 11px;border:1px solid rgba(255,255,255,.07);border-radius:11px;background:rgba(255,255,255,.025)}.live-rate-card span,.live-rate-card small{display:block;color:var(--muted);font-size:10px}.live-rate-card strong{display:block;margin:3px 0;font-size:17px;color:var(--warm)}.backup-actions{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.backup-status{margin:9px 0 0;color:var(--muted);font-size:11px}.backup-file{display:none}.personal-section.data-backup-section .mortgage-history-body{display:grid;gap:8px}@media(max-width:700px){.connectivity-copy small{display:none}.connectivity-mode{margin-left:auto}.live-rate-grid{grid-template-columns:1fr}}`;
