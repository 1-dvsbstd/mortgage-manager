(() => {
  ...
  function ensureMethodologySection(modal){
    ...
    section.innerHTML=`<summary><span><strong>How Mortgage Manager calculates</strong><small>See how projections, valuations and planning estimates are worked out.</small></span><span class="history-summary-chevron methodology-chevron" aria-hidden="true"></span></summary><div class="mortgage-history-body methodology-body"><div class="methodology-grid"><div class="methodology-item"><strong>Mortgage projection</strong><p>Uses your balance, rate, payment and selected overpayment. Interest is modelled monthly.</p></div><div class="methodology-item"><strong>Overpayments</strong><p>Compares the selected repayment path with the same mortgage without that extra payment.</p></div><div class="methodology-item"><strong>Home value</strong><p>Starts from your purchase price and applies local property-type HPI movement. A recent valuation overrides the model.</p></div><div class="methodology-item"><strong>Property forecast</strong><p>Uses the local historical HPI growth distribution for 1, 3 and 5-year estimates.</p></div><div class="methodology-item"><strong>Next-home planning</strong><p>Combines projected equity, savings and your borrowing-multiple assumption. It is not a lender affordability check.</p></div><div class="methodology-item"><strong>Market rates</strong><p>Online mode uses dated Bank of England mortgage-rate benchmarks for Upcoming payment scenarios.</p></div></div><p class="methodology-disclaimer"><strong>Planning estimates only.</strong> Actual valuations, lender affordability, fees, taxes and mortgage terms can differ.</p></div>`;
