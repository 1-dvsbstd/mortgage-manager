...
assert.match(index, /offline-v1-final\.css\?v=01523/, 'Final UI stylesheet should be loaded directly after legacy layers');
assert.match(index, /offline-v1-final\.js\?v=01523/, 'Final UI script should be loaded directly after legacy layers');
